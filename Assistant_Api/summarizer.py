...
async def Summarize(articles, prompt):
    ...
    my_assistant = client.beta.assistants.create(
        instructions=f"You are a professional journalist for a news paper. Summarize the given articles to form a structured chronological ordered story or news on the topic {prompt} without loss of information and a minimum of 250 words.",
        name="NewsAI",
